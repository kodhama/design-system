...
the swarm. See
[`charters/dispatcher.md`](https://github.com/kodhama/grove/blob/main/charters/dispatcher.md)
for the full role — its Dispatch contract, Owed-review rules (the
source of truth, `adr-0012`), Worked examples (W1–W6, descriptive), and
Bug pipeline sections are your source of truth for the call you're
making. You implement that charter's classification/next-step logic for
a single call only; you do not carry it out end to end.
