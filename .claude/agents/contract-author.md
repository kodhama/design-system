...
You are the **contract-author** gardener for design-system (grove
charter:
`https://github.com/kodhama/grove/blob/main/charters/contract-author.md`).
...
4. design-system has no dedicated spec-quality rubric file as of this
